...
POST_SUBMIT_SUCCESS_DELAY_SECONDS = 5
...
def _admin_book_reservation_impl(
    ...
    *,
    ...
    _wait_for_page_ready(page)
    _admin_progress(f"waiting {POST_SUBMIT_SUCCESS_DELAY_SECONDS}s after Make reservation")
    _sleep_with_cancel(POST_SUBMIT_SUCCESS_DELAY_SECONDS, cancel_event)
    return BookingResult(
        status="submitted",
        url=page.url,
        message="Clicked Make reservation and waited 5 seconds after submit.",
    )
